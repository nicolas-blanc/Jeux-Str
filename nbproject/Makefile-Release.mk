...
${OBJECTDIR}/Archer.o: Archer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Archer.o Archer.cpp
...
${OBJECTDIR}/Chateau.o: Chateau.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Chateau.o Chateau.cpp

${OBJECTDIR}/Chevalier.o: Chevalier.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Chevalier.o Chevalier.cpp
...
${OBJECTDIR}/Jeux.o: Jeux.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Jeux.o Jeux.cpp
...
${OBJECTDIR}/Magicien.o: Magicien.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Magicien.o Magicien.cpp
...
${OBJECTDIR}/Pretre.o: Pretre.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pretre.o Pretre.cpp
...
${OBJECTDIR}/Voleur.o: Voleur.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Voleur.o Voleur.cpp
